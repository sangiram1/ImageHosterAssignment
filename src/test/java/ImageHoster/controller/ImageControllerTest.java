...
public class ImageControllerTest {
  ...
  //This test checks the controller logic when the logged in submits the image to be uploaded in the
  // application and checks whether the logic returns the html file 'images.html'
  @Test
  ...
  //the form to edit the image and checks whether the logic returns the html file 'images/edit.html'
  @Test
  ...
  public void editImageWithNonOwnerOfTheImage() throws Exception {
    ...
    /* Corrected by Sangeeta - There is typo error in the object names */
    /* The objects referred here are wrong, it should be user1 and userProfile1. 1 is missing*/
    /* userProfile.setId(2);
    ...
    this.mockMvc.perform(get("/editImage")
        .param("imageId", "1")
        .session(session))
        .andExpect(model().attribute("editError",
  ...
  public void deleteImageWithNonOwnerOfTheImage() throws Exception {
    ...
    this.mockMvc.perform(delete("/deleteImage")
        .param("imageId", "1")
        .session(session))
        .andExpect(model().attribute("deleteError",
