...
public class CommentController {
  ...
  //The logged user will be determined from session object and added as the user creating the comment
  //The image details will be fetched using the dynamic params and will be added to the comment table
  ...
  //Once the comment is persisted, the image will be displayed showing all comments and other details
  @RequestMapping(value = "/image/{imageId}/{imageTitle}/comments", method = RequestMethod.POST)
  public String createComment(@PathVariable("imageId") Integer imageId, @PathVariable("imageTitle")
      String title, @RequestParam("comment") String commentText, Comment newComment, HttpSession session) {
